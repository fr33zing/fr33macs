...
(use-package flycheck
  ...
  (set-face-background 'flycheck-annotate-info-background "#3b3855")
  (set-face-attribute 'flycheck-annotate-info nil
		      :foreground (catppuccin-get-color 'mauve)
		      :background "#3b3855")
  (set-face-attribute 'flycheck-info nil
    :underline `(:color ,(catppuccin-get-color 'mauve) :style wave)
    :weight 'bold)

  (set-face-background 'flycheck-annotate-error-background "#413547")
  ...
  (set-face-background 'flycheck-annotate-warning-background "#423a44")
...
(use-package lsp-mode
  :custom
  (lsp-markdown-server-command "ltex-ls-plus")
  (lsp-markdown-server-command-args '("--endless")))
#+END_SRC
