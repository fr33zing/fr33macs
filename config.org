...
- make all org docs fully expanded by default
...
(use-package flycheck
  ...
  (set-flycheck-color "error"   'red    "#563949")
  (set-flycheck-color "warning" 'yellow "#564f4b")
  (set-flycheck-color "info"    'mauve  "#493f62")
)
...
(lsp-register-client
 (make-lsp-client
  ...
  (lsp-stdio-connection (lambda ()
      (cons (executable-find "ltex-ls-plus") '("--endless"))))
